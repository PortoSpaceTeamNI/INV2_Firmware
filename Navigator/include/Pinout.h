...
// BMI323 - 6-axis IMU: 6.4KHz, SPI 10MHz
#define BMI323_SPI_MISO_PIN SPI_MISO_PIN
#define BMI323_SPI_MOSI_PIN SPI_MOSI_PIN
#define BMI323_SPI_SCK_PIN SPI_SCK_PIN
#define BMI323_CS_PIN IMU1_CS_PIN
