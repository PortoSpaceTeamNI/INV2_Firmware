...
// lib/rocket_core. Included before HardwareCfg.h, which needs the IDs for MY_ID.
#include "rc_ids.h"
#include "rc_packet.h"
#include "rc_parser.h"
...
// Board IDs come from rc_ids.h; this unit's identity is MY_ID in HardwareCfg.h.
